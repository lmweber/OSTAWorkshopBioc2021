...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Spatially resolved transcriptomics (ST) example from the 10x Genomics Visium platform. Image source: [10x Genomics Visium website](https://www.10xgenomics.com/products/spatial-gene-expression)"}
...
```{r, echo=FALSE, out.width="60%", fig.align="center", fig.cap="Screenshot of [OSCA online book](https://bioconductor.org/books/release/OSCA/)."}
