...
```{r, echo=FALSE, out.width="50%", fig.align="center", fig.cap="Schematic of data format from 10x Genomics Visium platform."}
...
```{r, echo=FALSE, out.width="70%", fig.align="center", fig.cap="Screenshot of [OSCA online book](https://bioconductor.org/books/release/OSCA/)."}
